"""
This script is just a sandbox and copy of tournament.py
It was used to test different heuristics so original script remains unchanged
"""
...
from game_agent import heuristics1
from game_agent import heuristics2
from game_agent import heuristics3
...
def main():
    ...
    test_agents = [Agent(CustomPlayer(score_fn=heuristics2, **CUSTOM_ARGS), "Student2"),
                   Agent(CustomPlayer(score_fn=heuristics1, **CUSTOM_ARGS), "Student1")]
                   #Agent(CustomPlayer(score_fn=heuristics3, **CUSTOM_ARGS), "Student4")]
